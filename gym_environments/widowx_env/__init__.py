...
register(id='widowx_reacher-v7',
         entry_point='widowx_env.envs.v7_widowx_pybullet_no_start_sim_randomGoal:WidowxEnv',
         max_episode_steps=100
         )
...
register(id='widowx_reacher-v8',
         entry_point='widowx_env.envs.v8_widowx_pybullet_no_start_sim_goal_oriented_randomGoal:WidowxEnv',
         max_episode_steps=100
         )
