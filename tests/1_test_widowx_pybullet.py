...
# import WidowX urdf and fix it to the ground
robot = p.loadURDF("../gym_environments/widowx_original/widowx_original/envs/URDFs/widowx/widowx.urdf", [0, 0, 0], useFixedBase=1)
