...
# df1 = pd.read_csv("logs/a2c_1M_ReachingJaco-v1/a2c/all_rewards.csv")
df2 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/acktr/all_rewards.csv")
# df3 = pd.read_csv("logs/ddpg_1M_ReachingJaco-v1/ddpg/all_rewards.csv")
df4 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/ppo2/all_rewards.csv")
df5 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/sac/all_rewards.csv")
df6 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/td3/all_rewards.csv")
# df7 = pd.read_csv("logs/trpo_1M_ReachingJaco-v1/trpo/all_rewards.csv")
...
# ff1 = pd.read_csv("logs/a2c_1M_ReachingJaco-v1/a2c/results_seed_exp.csv")
ff2 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/acktr/results_seed_exp.csv")
# ff3 = pd.read_csv("logs/ddpg_1M_ReachingJaco-v1/ddpg/results_seed_exp.csv")
ff4 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/ppo2/results_seed_exp.csv")
ff5 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/sac/results_seed_exp.csv")
ff6 = pd.read_csv("logs/train_2M_ReachingJaco-v1_tuned/td3/results_seed_exp.csv")
# ff7 = pd.read_csv("logs/trpo_1M_ReachingJaco-v1/trpo/results_seed_exp.csv")
...
save_dir = "experiment_reports/2M_ReachingJaco-v1_tuned/"
