...
log_dir="logs/benchmark/train_widowx_reacher-v16_noptepochs20/"
...
do
    ...
    # python3 mylib/plot_1seed.py -f ${log_dir}a2c/${env}_$i/
    #
    # echo "ACKTR $i"
    # python3 3_enjoy.py --algo acktr --env ${env} -f ${log_dir} --exp-id $i --no-render -n ${nsteps}
    # python3 mylib/plot_1seed.py -f ${log_dir}acktr/${env}_$i/
    #
    # echo "DDPG $i"
...
# python mylib/clean_random_training.py -f ${random_log_folder}
...
# python3 mylib/plot_experiment.py -f ${log_dir}her_sac/ --env ${env_her} --nb-seeds ${nb_seeds} -n ${nsteps}
# python3 mylib/plot_experiment.py -f ${log_dir}her_td3/ --env ${env_her} --nb-seeds ${nb_seeds} -n ${nsteps}


# # STEP 3: Plot learning curves and training stats
# python3 mylib/plot_experiment_comparison.py -f ${log_dir} -s ${save_dir} -e ${appendix} -r ${random_log_folder}

## STEP 4: compare learning curves between 2 envs
# python3 mylib/plot_comp_envs_learning_curves.py -f1 ${log_dir} -f2 ${log_dir2} -s ${save_dir2}

# # IF OPTIMISATION
# # python3 mylib/plot_opti_report.py
# python3 mylib/plot_opti_best.py
# python mylib/clean_opti_params.py -f ${opti_dir}a2c/
# python mylib/clean_opti_params.py -f ${opti_dir}acktr/
# python mylib/clean_opti_params.py -f ${opti_dir}ddpg/
# python mylib/clean_opti_params.py -f ${opti_dir}ppo2/
# python mylib/clean_opti_params.py -f ${opti_dir}sac/
# python mylib/clean_opti_params.py -f ${opti_dir}td3/
# python mylib/clean_opti_params.py -f ${opti_dir}trpo/
# python mylib/clean_opti_params.py -f ${opti_dir}her/
